...
let Api_url="https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=AIzaSyAegZV7gtFfnAwYVCQr-7UzsQWwIi9bGRo"
...
if(message.includes("open") && message.includes("chat")){
  ...
  speak("i am virtual assistant ,created by kartik karnwal and the group includes gopal bansal and gaurav kumar")
...
speak(time)
  ...
  let finalText="this is what i found on internet regarding" + message.replace("Simbha","") || message.replace("Simbha","")
  speak(finalText)
  window.open(`https://www.google.com/search?q=${message.replace("Simbha","")}`,"_blank")
}
}
